...
\begin{tabular}{llcrrrrll}\toprule
\textbf{\S} & \textbf{Setting} & \textbf{Protocol} & $\bm{N}$ & \textbf{Range} & $\bm{\Delta_{\min}^{\text{(indep)}}}$ & $\bm{\Delta_{\min}^{\text{(paired)}}}$ & \textbf{Pairwise} & \textbf{Multiplicity} \\\midrule
\ref{sec:full_budget} & Qwen2.5-7B LoRA, GSM8K full & training & 1319 & 3.0 & 3.8 & 2.9--3.5 & --- & --- \\
\ref{sec:budget_degradation} & Qwen2.5-7B LoRA, GSM8K sub. & few-shot & 200 & 8.0 & 9.8 & --- & Not resolvable & --- \\
\ref{sec:budget_degradation} & Qwen2.5-7B LoRA, seed 42 (128~tok) & training & 200 & 5.5 & 9.8 & 8.7--9.3 & Not resolvable & --- \\
\ref{sec:seeds} & Qwen2.5-7B LoRA, seed 42 (256~tok) & training & 200 & 12.5 & 9.7 & 8.7--9.3 & Resolvable & Not resolvable \\
\ref{sec:seeds} & Qwen2.5-7B LoRA, seed 43 (256~tok) & training & 200 & 14.0 & 9.1 & --- & Resolvable & Not resolvable \\
\ref{sec:seeds} & Qwen2.5-7B LoRA, seed 44 (256~tok) & training & 200 & 13.5 & 9.1 & --- & Resolvable & Not resolvable \\
\ref{sec:small_scale} & Qwen2.5-1.5B LoRA & zero-shot & 200 & 3.5 & 3.4 & --- & \emph{Invalid} & --- \\
\ref{sec:full_ft} & Qwen2.5-1.5B full fine-tune & training & 200 & 6.0 & 9.4 & --- & Not resolvable & --- \\
\ref{sec:mistral} & Mistral-7B LoRA & training & 200 & 11.0 & 8.8 & 7.2--7.9 & \textbf{Resolvable} & Not resolvable \\
